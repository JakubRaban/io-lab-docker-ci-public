...
SCHEMA_VSC_URL = https://github.com/JakubRaban/$(REPO_NAME)
...
image:
	docker build -t jakubraban/io-lab-docker-ci:latest \
	...
	docker tag jakubraban/io-lab-docker-ci:latest jakubraban/io-lab-docker-ci:$(TAG)
	
push: image
	docker push jakubraban/io-lab-docker-ci:latest
	docker push jakubraban/io-lab-docker-ci:$(TAG)
